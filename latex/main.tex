...
\multirow{6}{*}{\texttt{BOOK}} & \multirow{6}{*}{\underline{\texttt{BookID}}} & \multirow{3}{*}{\texttt{PublisherID}} & \texttt{BookID} & INT \\ \cline{4-5}
& & & \texttt{ISBN} & VARCHAR(17) \\ \cline{4-5}
& & & \texttt{Title} & VARCHAR(255) \\ \cline{4-5}
& & & \texttt{SubjectCategory} & VARCHAR(100) \\ \cline{4-5}
& & & \texttt{PublicationYear} & INT \\ \cline{4-5}
& & & \texttt{PublisherID} & INT \\ \hline
\end{tabular}
\end{table}
