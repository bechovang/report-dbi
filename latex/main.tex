...
% Định nghĩa lại để fix lỗi Tiếng Việt
...
\newtcblisting{sqlcode}[2][]{
    ...
    listing options={
        language=SQL,
        basicstyle=\ttfamily\small, % Font Courier New
        keywordstyle=\color{blue}\bfseries,
        commentstyle=\color{green!50!black}\itshape,
        stringstyle=\color{red},
        breaklines=true,
        showstringspaces=false,
        tabsize=2,
        % Cấu hình quan trọng để fix lỗi Tiếng Việt:
        escapeinside={(*}{*)}, % Dùng (* ... *) để viết Tiếng Việt
        inputencoding=utf8,
        extendedchars=true,
    },
    #1
...
\begin{sqlcode}{INSERT dữ liệu vào BOOK\_AUTHOR}
...
\begin{sqlcode}{Test ufn\_CalculateOverdueFine}
-- Trả đúng hạn
