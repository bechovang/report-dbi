...
\begin{tabular}{@{}|l|l|l|@{}}
\hline
\textbf{Thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Atomic?} & \textbf{Ghi chú} \\ \hline
PublisherID & INT & [OK] & Giá trị đơn, duy nhất \\ \hline
Name & VARCHAR(255) & [OK] & Chuỗi ký tự đơn \\ \hline
Address & VARCHAR(500) & [OK] & Chuỗi ký tự đơn \\ \hline
ContactNumber & VARCHAR(50) & [OK] & Chuỗi ký tự đơn \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Kiểm tra 1NF - AUTHOR}
\begin{tabular}{@{}|l|l|l|@{}}
\hline
\textbf{Thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Atomic?} & \textbf{Ghi chú} \\ \hline
AuthorID & INT & [OK] & Giá trị đơn, duy nhất \\ \hline
Name & VARCHAR(255) & [OK] & Chuỗi ký tự đơn \\ \hline
Nationality & VARCHAR(100) & [OK] & Chuỗi ký tự đơn \\ \hline
YearOfBirth & INT & [OK] & Giá trị số nguyên \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Kiểm tra 1NF - MEMBER}
\begin{tabular}{@{}|l|l|l|@{}}
\hline
\textbf{Thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Atomic?} & \textbf{Ghi chú} \\ \hline
MemberID & INT & [OK] & Giá trị đơn, duy nhất \\ \hline
Name & VARCHAR(255) & [OK] & Chuỗi ký tự đơn \\ \hline
Address & VARCHAR(500) & [OK] & Chuỗi ký tự đơn \\ \hline
Phone & VARCHAR(20) & [OK] & Chuỗi ký tự đơn \\ \hline
MembershipType & VARCHAR(50) & [OK] & Chuỗi ký tự đơn \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Kiểm tra 1NF - BOOK}
\begin{tabular}{@{}|l|l|l|@{}}
\hline
\textbf{Thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Atomic?} & \textbf{Ghi chú} \\ \hline
BookID & INT & [OK] & Giá trị đơn, duy nhất \\ \hline
ISBN & VARCHAR(17) & [OK] & Chuỗi ký tự đơn \\ \hline
Title & VARCHAR(255) & [OK] & Chuỗi ký tự đơn \\ \hline
SubjectCategory & VARCHAR(100) & [OK] & Chuỗi ký tự đơn \\ \hline
PublicationYear & INT & [OK] & Giá trị số nguyên \\ \hline
PublisherID & INT & [OK] & Khóa ngoại, giá trị đơn \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Kiểm tra 1NF - BOOK\_COPY}
\begin{tabular}{@{}|l|l|l|@{}}
\hline
\textbf{Thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Atomic?} & \textbf{Ghi chú} \\ \hline
CopyID & INT & [OK] & Giá trị đơn, duy nhất \\ \hline
BookID & INT & [OK] & Khóa ngoại, giá trị đơn \\ \hline
Condition & VARCHAR(50) & [OK] & Chuỗi ký tự đơn \\ \hline
Status & VARCHAR(20) & [OK] & Chuỗi ký tự đơn \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Kiểm tra 1NF - LOAN}
\begin{tabular}{@{}|l|l|l|@{}}
\hline
\textbf{Thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Atomic?} & \textbf{Ghi chú} \\ \hline
LoanID & INT & [OK] & Giá trị đơn, duy nhất \\ \hline
MemberID & INT & [OK] & Khóa ngoại, giá trị đơn \\ \hline
CopyID & INT & [OK] & Khóa ngoại, giá trị đơn \\ \hline
BorrowDate & DATE & [OK] & Giá trị ngày đơn \\ \hline
DueDate & DATE & [OK] & Giá trị ngày đơn \\ \hline
ReturnDate & DATE & [OK] & Giá trị ngày đơn (có thể NULL) \\ \hline
OverdueFine & DECIMAL(10,2) & [OK] & Giá trị số đơn \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Kiểm tra 1NF - BOOK\_AUTHOR}
\begin{tabular}{@{}|l|l|l|@{}}
\hline
\textbf{Thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Atomic?} & \textbf{Ghi chú} \\ \hline
BookID & INT & [OK] & Khóa chính, giá trị đơn \\ \hline
AuthorID & INT & [OK] & Khóa chính, giá trị đơn \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|c|l|c|}
\hline
\textbf{STT} & \textbf{Tên bảng} & \textbf{Đã đáp ứng 1NF?} \\ \hline
1 & PUBLISHER & \textbf{CÓ} \\ \hline
2 & AUTHOR & \textbf{CÓ} \\ \hline
3 & MEMBER & \textbf{CÓ} \\ \hline
4 & BOOK & \textbf{CÓ} \\ \hline
5 & BOOK\_COPY & \textbf{CÓ} \\ \hline
6 & LOAN & \textbf{CÓ} \\ \hline
7 & BOOK\_AUTHOR & \textbf{CÓ} \\ \hline
\end{tabular}
\end{table}
